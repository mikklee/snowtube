//! Language to locale (hl/gl) mapping for YouTube InnerTube API

use std::fmt;
use std::sync::OnceLock;

/// A language option with its corresponding YouTube locale codes
...
pub struct LanguageOption {
    ...
    /// YouTube language code (hl parameter, e.g., "ja", "ko")
    pub hl: &'static str,
    /// YouTube region code (gl parameter, e.g., "JP", "KR")
    pub gl: &'static str,
}
