//! Minimal example demonstrating the low-level video player API.
//!
//! This example shows how to use Video and VideoPlayer directly
//! for custom video player implementations.
